...
class CSVSolarPredictor:
    ...
    def save_models(self, folder_path='src/non-tf/baseline/saved_models'):
...
if __name__ == "__main__":
    csv_file_path = "src/non-tf/baseline/processed_data/solar_data_simple_fill.csv"  # เปลี่ยนเป็น path ของคุณ
