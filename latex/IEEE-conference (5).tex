...
\begin{document}
	...
	\begin{equation*} 
		\begin{split}
			&\textbf{Input:} \quad \mathbf{X}_{t-671:t} \in \mathbb{R}^{672 \times N_{feat}} \\
			&\mathbf{H} = \mathbf{ReLU}(\mathtt{Conv1D}(\mathbf{X}_{t-671:t}, k=3, f=128)) \\ 
			&\mathbf{v}_{\mathtt{out}} = \mathbf{Flatten}(\mathbf{H}) \\ 
			&\hat{\mathbf{y}}=\text{Dense}(\mathbf{v}_{\mathtt{out}}) \\
	...
	\begin{equation*}
		\begin{split}
			\mathbf{h}_T, \mathbf{c}_T &= \mathbf{LSTM}(\mathbf{X}_{t-671:t}; \small hidden=128) \\
	...
	\begin{equation*}
		\begin{split}
			&\mathbf{h}_0, \mathbf{c}_0 = \text{RNN}(\mathbf{LSTMCell}(\mathbf{X}_{t-671:t}; \small hidden\!=\!128)) \\
	...
	\begin{equation*}
		\begin{split}
			&\mathbf{h}_n, \mathbf{c}_n = \text{LSTMCell}(\hat{\mathbf{y}}_{n-1}, [\mathbf{h}_{n-1}, \mathbf{c}_{n-1}]; \small hidden\!=\!128) \\
		...
		{\small
			\resizebox{\columnwidth}{!}{%
				\begin{tabular}{|c|c|c|c|c|c|c|}
					...
					\hline
					\multicolumn{1}{|c|}{\shortstack{AR}} & 0.084M & Baseline & 0.0418 & 0.0836 & -2.63 & -- \\
					\cline{2-7}
