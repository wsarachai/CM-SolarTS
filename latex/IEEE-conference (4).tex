...
\begin{table}[htbp]
	...
	\begin{tabularx}{\columnwidth}{|c|>{\centering}X|>{\centering}X|>{\centering}X|>{\centering}X|>{\centering}X|c|}
		\hline
		\textbf{Model} & \textbf{Parameters} & \textbf{Strategy} & \textbf{MAE} & \textbf{Gain} & \textbf{Best} & $\mathbf{R}^{2}$  
		\rule{0pt}{10pt} \\ 
		\hline
		
		\multirow{4}{*}{CNN} & \textbf{8.24 M} & \textbf{Baseline} & \textbf{0.0532} & -- & \textbf{0.0901} &  0.85 \rule{0pt}{8pt} \\
		\cline{2-7}
		
		& 8.24 M & Datetime & 0.0609 & -4.1 & 0.0970 & 0.83 \rule{0pt}{8pt} \\ 
		\cline{2-7}
		& 8.24 M & Cyclical & 0.0591 & -11.1 & 0.0987 & 0.82 \rule{0pt}{8pt} \\ 
		\cline{2-7}
		& 8.26 M & Lag & 0.0588 & -10.7 & 0.0946 & 0.83 \rule{0pt}{8pt} \\ 
		\hline
		
		\multirow{4}{*}{LSTM} & 0.44 M & Baseline & 0.0408 & -- & 0.0864 & -2.87 \rule{0pt}{8pt} \\ \cline{2-7}
		& \textbf{0.54 M} & \textbf{Datetime} & \textbf{0.0408} & \textbf{+5.3} & \textbf{0.0797} & -3.21 \rule{0pt}{8pt} \\ \cline{2-7}
		& 0.60 M & Cyclical & 0.0409 & +5.1 & 0.0801 & -3.84 \rule{0pt}{8pt} \\ \cline{2-7}
		& 1.00 M & Lag & 0.0427 & -0.9 & 0.0815 & -8.42 \rule{0pt}{8pt} \\ \hline
		\multirow{4}{*}{AR-LSTM} & 0.084 M & Baseline & 0.0418 & -- & 0.0836 & -2.63 \rule{0pt}{8pt} \\ \cline{2-7}
		& 0.089 M & Datetime & 0.0418 & +3.2 & 0.0837 & -3.65 \rule{0pt}{8pt} \\ \cline{2-7}
		& \textbf{0.092 M} & \textbf{Cyclical} & \textbf{0.0392} & \textbf{+9.0} & \textbf{0.0817} & -4.03 \rule{0pt}{8pt} \\ \cline{2-7}
		& 0.116 M & Lag & 0.0406 & +6.0 & 0.0817 & -8.46 \rule{0pt}{8pt} \\ \hline
	\end{tabularx}
\end{table}
