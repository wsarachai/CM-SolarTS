...
% Force US Letter size in the output PDF (safe with IEEEtran)
\ifpdf
\pdfpagewidth=8.5in
\pdfpageheight=11in
\fi
...
\begin{document}
	...
	\begin{table}[htbp]
		...
		\renewcommand{\arraystretch}{1.2} % เพิ่มระยะห่างแนวตั้งเล็กน้อยให้อ่านง่าย
		% ใช้ 3 คอลัมน์: Variable | Description (ยืด) | Unit
		\begin{tabularx}{\columnwidth}{|c|>{\centering\arraybackslash}X|c|}
			\hline
			...
			slhf      & Surface upward latent heat flux (accum.)             & J/m$^2$ \\ \hline
			sshf      & Surface upward sensible heat flux (accum.)           & J/m$^2$ \\ \hline
			ssr       & Net shortwave radiation at surface (accum.)          & J/m$^2$ \\ \hline
			ssrd      & Downward shortwave radiation (accum.)                & J/m$^2$ \\ \hline
			str       & Net longwave radiation at surface (accum.)           & J/m$^2$ \\ \hline
			strd      & Downward longwave radiation (accum.)                 & J/m$^2$ \\ \hline
			tp        & Total precipitation (accum.)                          & m \\ \hline
		\end{tabularx}
	\end{table}
	...
	\begin{table}[htbp]
		...
		\setlength{\tabcolsep}{3pt}
		\footnotesize
		\begin{tabularx}{\columnwidth}{|c|>{\centering}X|>{\centering}X|c|}
			\hline
			\textbf{Feature Name} & \textbf{Symbol} & \textbf{Unit} & \textbf{Range} \rule{0pt}{10pt} \\ \hline
			Equation of Time      & $EoT$           & min           & $[-14, 16]$ \rule{0pt}{8pt} \\ \hline
			Zenith Angle          & $\theta_z$      & deg           & $[0, 180]$  \rule{0pt}{8pt} \\ \hline
			Elevation Angle       & $\alpha$        & deg           & $[-90, 90]$ \rule{0pt}{8pt} \\ \hline
			Azimuth Angle         & $\gamma_s$      & deg           & $[0, 360]$  \rule{0pt}{8pt} \\ \hline
			Declination Angle     & $\delta$        & deg           & $[-23.45, 23.45]$ \rule{0pt}{8pt} \\ \hline
			Hour Angle            & $H$             & deg           & $[-180, 180]$  \rule{0pt}{8pt} \\ \hline
			Incidence Angle       & $\theta_i$      & deg           & $[0, 90]$ \rule{0pt}{8pt} \\ \hline
		\end{tabularx}
	\end{table}
	...
	\begin{table}[htbp]
		...
		\begin{center}
			\renewcommand{\arraystretch}{1.3} % เพิ่มระยะห่างระหว่างแถว (ค่า default = 1.0)
			\begin{tabular}{|c|c|c|c|c|c|c|}
				\hline
				\textbf{Model} & \multicolumn{6}{|c|}{\textbf{Performance Metrics}} \\ 
				\cline{2-7}
				\textbf{} & \textbf{\textit{Params}} & \textbf{\textit{Strategy}} & \textbf{\textit{MAE}} & \textbf{\textit{RMSE}} & \textbf{\textit{$\mathbf{R}^{2}$}} & \textbf{\textit{MAE$_{gain}$}} \\
				\hline
				CNN & 8.24 M & Baseline & 0.0532 & 0.0901 & \textbf{0.85} & -- \\
				\cline{2-7}
				& 8.24 M & Datetime & 0.0609 & 0.0970 & 0.83 & -14.47 \\
				\cline{2-7}
				& 8.24 M & Cyclical & 0.0591 & 0.0987 & 0.82 & -11.09 \\
				\cline{2-7}
				& 8.26 M & Lag & 0.0588 & 0.0946 & 0.83 & -10.53 \\
				\hline
				LSTM & 0.44 M & Baseline & 0.0408 & 0.0864 & -2.87 & -- \\
				\cline{2-7}
				& 0.54 M & Datetime & 0.0408 & 0.0797 & -3.21 & 0.00 \\
				\cline{2-7}
				& 0.60 M & Cyclical & 0.0409 & 0.0801 & -3.84 & -0.25 \\
				\cline{2-7}
				& 1.00 M & Lag & 0.0427 & 0.0815 & -8.42 & -4.66 \\
				\hline
				\shortstack{AR} & 0.084 M & Baseline & 0.0418 & 0.0836 & -2.63 & -- \\
				\cline{2-7}
				LSTM 
				& 0.089 M & Datetime & 0.0418 & 0.0837 & -3.65 & 0.00 \\
				\cline{2-7}
				& 0.092 M & Cyclical & \textbf{0.0392} & 0.0817 & -4.03 & +6.22 \\
				\cline{2-7}
				& 0.116 M & Lag & 0.0406 & 0.0817 & -8.46 & +2.87 \\
				\hline
			\end{tabular}
