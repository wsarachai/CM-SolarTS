...
\multirow{4}{*}{CNN} & 8.24 M & Baseline & 0.0532 & -- & -- &  \rule{0pt}{8pt} \\
 \cline{2-6}

 & 8.24 M & Datetime & 0.0609 & -14.5 & -- &  \rule{0pt}{8pt} \\ 
 \cline{2-6}
 & 8.24 M & Cyclical & 0.0591 & -11.1 & -- &  \rule{0pt}{8pt} \\ 
 \cline{2-6}
 & 8.26 M & Lag & \textbf{0.0589} & \textbf{-10.7} & \textbf{Yes} -- & \rule{0pt}{8pt} \\ 
 \hline
 
\multirow{4}{*}{LSTM} & 0.44 M & Baseline & 0.0431 & -- & -- &  \rule{0pt}{8pt} \\ \cline{2-6}
 & 0.54 M & Datetime & \textbf{0.0408} & \textbf{+5.3} & \textbf{Yes} -- & \rule{0pt}{8pt} \\ \cline{2-6}
 & 0.60 M & Cyclical & 0.0409 & \textbf{+5.1} & \rule{0pt}{8pt} -- & \\ \cline{2-6}
 & 1.00 M & Lag & 0.0427 & -0.9 &  \rule{0pt}{8pt} -- & \\ \hline
\multirow{4}{*}{AR-LSTM} & 0.084 M & Baseline & \textbf{0.0432} & -- & \textbf{Yes} \rule{0pt}{8pt} -- & \\ \cline{2-6}
 & 0.089 M & Datetime & 0.0418 & -4.2 &  \rule{0pt}{8pt} -- & \\ \cline{2-6}
 & 0.092 M & Cyclical & 0.0411 & -2.5 &  \rule{0pt}{8pt} -- & \\ \cline{2-6}
 & 0.116 M & Lag & 0.0406 & -1.2 &  \rule{0pt}{8pt} -- & \\ \hline
\end{tabularx}
\end{table}
