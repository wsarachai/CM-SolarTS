...
\hline
\textbf{Model} & \textbf{Parameters} & \textbf{Strategy} & \textbf{MAE} & \textbf{Gain} & \textbf{Best} & \textbf{all}  
\rule{0pt}{10pt} \\ 
\hline

\multirow{4}{*}{CNN} & \textbf{8.24 M} & \textbf{Baseline} & \textbf{0.0532} & -- & \textbf{Yes} &  \rule{0pt}{8pt} \\
 \cline{2-7}

 & 8.24 M & Datetime & 0.0554 & -4.1 & -- &  \rule{0pt}{8pt} \\ 
 \cline{2-7}
 & 8.24 M & Cyclical & 0.0591 & -11.1 & -- &  \rule{0pt}{8pt} \\ 
 \cline{2-7}
 & 8.26 M & Lag & 0.0589 & -10.7 & -- & \rule{0pt}{8pt} \\ 
 \hline
 
\multirow{4}{*}{LSTM} & 0.44 M & Baseline & 0.0431 & -- & -- &  \rule{0pt}{8pt} \\ \cline{2-7}
 & \textbf{0.54 M} & \textbf{Datetime} & \textbf{0.0408} & \textbf{+5.3} & \textbf{Yes} & \rule{0pt}{8pt} \\ \cline{2-7}
 & 0.60 M & Cyclical & 0.0409 & +5.1 & -- & \rule{0pt}{8pt} \\ \cline{2-7}
 & 1.00 M & Lag & 0.0427 & -0.9 & -- & \rule{0pt}{8pt} \\ \hline
\multirow{4}{*}{AR-LSTM} & 0.084 M & Baseline & 0.0432 & -- & -- & \rule{0pt}{8pt} \\ \cline{2-7}
 & 0.089 M & Datetime & 0.0418 & +3.2 & -- & \rule{0pt}{8pt} \\ \cline{2-7}
 & \textbf{0.092 M} & \textbf{Cyclical} & \textbf{0.0393} & \textbf{+9.0} & \textbf{Yes} & \rule{0pt}{8pt} \\ \cline{2-7}
 & 0.116 M & Lag & 0.0406 & +6.0 & -- & \rule{0pt}{8pt} \\ \hline
\end{tabularx}
\end{table}
